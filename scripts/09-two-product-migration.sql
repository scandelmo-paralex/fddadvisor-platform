-- ============================================================================
-- MIGRATION: Add Two-Product Architecture (FDDAdvisor + FDDHub)
-- This script safely adds new tables and columns without breaking existing ones
-- ============================================================================

-- Add demographics columns to existing buyer_profiles table
...
ADD COLUMN IF NOT EXISTS signup_source TEXT DEFAULT 'fddadvisor';

-- ============================================================================
-- NEW TABLE: Lead Invitations (for FDDHub)
-- ============================================================================
...
-- ============================================================================
-- NEW TABLE: Lead FDD Access (tracks which FDDs a lead can view)
-- ============================================================================
...
-- ============================================================================
-- NEW TABLE: White Label Settings (customize FDD Viewer per franchise)
-- ============================================================================
...
CREATE INDEX IF NOT EXISTS idx_lead_fdd_access_buyer_id ON lead_fdd_access(buyer_id);
CREATE INDEX IF NOT EXISTS idx_lead_fdd_access_franchise_id ON lead_fdd_access(franchise_id);
CREATE INDEX IF NOT EXISTS idx_lead_fdd_access_franchisor_id ON lead_fdd_access(franchisor_id);
CREATE INDEX IF NOT EXISTS idx_white_label_settings_franchise_id ON white_label_settings(franchise_id);
...
-- ============================================================================
-- FUNCTION: Auto-create FDD access when invitation is accepted
-- ============================================================================
...
DROP TRIGGER IF EXISTS auto_create_fdd_access ON lead_invitations;
...
-- ============================================================================
-- MIGRATION COMPLETE!
-- This adds the two-product architecture without breaking existing tables
-- ============================================================================
