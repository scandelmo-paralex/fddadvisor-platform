...
-- Run this script in Supabase SQL Editor after running script 13

-- 1. Burger King
INSERT INTO franchises (
  franchise_name, brand_description, industry, franchise_score,
  score_breakdown, opportunities, concerns,
  ...
  'Food & Beverage',
  312,
  '{"financial_performance": 0, "business_model": 123, "support_training": 89, "legal_compliance": 70, "franchisee_satisfaction": 30}'::jsonb,
  '[
...
INSERT INTO franchises (
  ...
  'Retail',
  320,
  '{"financial_performance": 0, "business_model": 135, "support_training": 85, "legal_compliance": 45, "franchisee_satisfaction": 55}'::jsonb,
  '[
...
INSERT INTO franchises (
  ...
  'Food & Beverage',
  268,
  '{"financial_performance": 0, "business_model": 123, "support_training": 65, "legal_compliance": 50, "franchisee_satisfaction": 30}'::jsonb,
  '[
...
INSERT INTO franchises (
  ...
  'Food & Beverage',
  360,
  '{"financial_performance": 85, "business_model": 100, "support_training": 70, "legal_compliance": 65, "franchisee_satisfaction": 40}'::jsonb,
  '[
