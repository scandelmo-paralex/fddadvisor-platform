-- Fix page mappings for Ace Handyman Services
-- Franchise ID: 1bd52965-5055-48f3-97df-af529fd4d120

-- First, delete existing mappings for this franchise
DELETE FROM fdd_item_page_mappings WHERE franchise_slug = 'ace-handyman-services';

-- Insert Items 1-23 with CORRECT page numbers from TOC
...
('ace-handyman-services', 'item', 2, 'Item 2', 12),
('ace-handyman-services', 'item', 3, 'Item 3', 13),
('ace-handyman-services', 'item', 4, 'Item 4', 14),
('ace-handyman-services', 'item', 5, 'Item 5', 15),
('ace-handyman-services', 'item', 6, 'Item 6', 16),
('ace-handyman-services', 'item', 7, 'Item 7', 19),
('ace-handyman-services', 'item', 8, 'Item 8', 23),
('ace-handyman-services', 'item', 9, 'Item 9', 25),
('ace-handyman-services', 'item', 10, 'Item 10', 26),
('ace-handyman-services', 'item', 11, 'Item 11', 26),
('ace-handyman-services', 'item', 12, 'Item 12', 38),
('ace-handyman-services', 'item', 13, 'Item 13', 42),
('ace-handyman-services', 'item', 14, 'Item 14', 44),
('ace-handyman-services', 'item', 15, 'Item 15', 45),
('ace-handyman-services', 'item', 16, 'Item 16', 46),
('ace-handyman-services', 'item', 17, 'Item 17', 47),
('ace-handyman-services', 'item', 18, 'Item 18', 49),
('ace-handyman-services', 'item', 19, 'Item 19', 50),
('ace-handyman-services', 'item', 20, 'Item 20', 61),
('ace-handyman-services', 'item', 21, 'Item 21', 67),
('ace-handyman-services', 'item', 22, 'Item 22', 68),
('ace-handyman-services', 'item', 23, 'Item 23', 68);
...
('ace-handyman-services', 'quick_link', 3, 'Item 19', 50),
