...
export function FDDViewer({
  ...
  const [activeTab, setActiveTab] = useState<"document" | "franchisescore" | "resources">("document")
      ...
      <div className="max-w-4xl mx-auto p-6 space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">Educational content to help you evaluate franchise opportunities</p>
          </div>
        </div>
        ...
        <Card className="overflow-hidden border-slate-200 dark:border-slate-700">
          <div className="p-4 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 border-b border-slate-200 dark:border-slate-700">
            <div className="flex items-center gap-2">
              ...
              <h2 className="font-semibold text-lg">FDD Review | Detailed Guide to Review FDD</h2>
            </div>
            <p className="text-sm text-muted-foreground mt-1">Franchise Disclosure Document Explained</p>
          </div>
          <div className="aspect-video w-full bg-black">
            <iframe
              src="https://www.youtube.com/embed/LQpXxpnwEOA"
              title="FDD Review | Detailed Guide to Review FDD (Franchise Disclosure Document Explained)"
        ...
        <Card className="p-4 border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900/50">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="font-semibold">Additional Resources</h2>
          </div>
          <div className="space-y-3">
            <a
              href="https://www.ftc.gov/business-guidance/resources/franchise-rule-compliance-guide"
              target="_blank"
              rel="noopener noreferrer"
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-medium text-sm">FTC Franchise Rule Compliance Guide</p>
                  <p className="text-xs text-muted-foreground">Official guidance for understanding franchise regulations</p>
                </div>
              </div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-medium text-sm">SBA Franchise Guide</p>
                  <p className="text-xs text-muted-foreground">Small Business Administration resources for franchise buyers</p>
                </div>
              </div>
              <ExternalLink className="h-4 w-4 text-muted-foreground group-hover:text-foreground transition-colors" />
            </a>
        ...
        <Card className="border-amber-200 dark:border-amber-900/50 bg-amber-50/50 dark:bg-amber-950/20 p-4">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h2 className="font-semibold text-amber-900 dark:text-amber-100">Before You Invest</h2>
          </div>
          <ul className="space-y-2 text-sm text-amber-900 dark:text-amber-100">
            <li className="flex items-start gap-2">
              <span className="font-bold">•</span>
              <span>Read the entire FDD carefully, especially Items 3, 4, 7, 19, and 20</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="font-bold">•</span>
              <span>Contact current and former franchisees listed in Item 20</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="font-bold">•</span>
              <span>Consult with a franchise attorney and accountant</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="font-bold">•</span>
              <span>Take the full 14-day waiting period to make an informed decision</span>
            </li>
          </ul>
        </Card>
      </div>
  ...
  const rightPanel = (
    <div className={`flex h-full flex-col ${isPdfVisible ? "" : ""}`}>
      <div className={`space-y-4 ${isPdfVisible ? "p-4 pr-6" : "py-6"}`}>
        ...
        <Card className="p-4 border-slate-200 dark:border-slate-800" data-tour="fdd-navigation">
        ...
        <Card className="p-4 border-slate-200 dark:border-slate-800" data-tour="engagement-progress">
          <button
      ...
      {onAddNote && onUpdateNote && onDeleteNote && (
        ...
        >
          <Card className="h-full flex flex-col p-4 border-slate-200 dark:border-slate-800" data-tour="notes-section">
  ...
  const handleTabClick = (tab: "document" | "franchisescore" | "resources") => {
    ...
    <div className="flex flex-col h-full relative bg-background">
      ...
      <div className="flex-1 overflow-hidden">
        {activeTab === "document" ? (
          ...
          // Resources tab - show educational content
          resourcesTab
        )}
      </div>
